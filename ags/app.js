...
// sass:/home/silver/.config/ags/style.scss
var style_default = "window.Bar {\n  background: @theme_bg_color;\n  color: @theme_fg_color;\n  font-weight: bold;\n  border-radius: 10px;\n}\nwindow.Bar > centerbox {\n  background: @theme_bg_color;\n  border-radius: 10px;\n  margin: 8px;\n}\nwindow.Bar button {\n  border-radius: 8px;\n  margin: 2px;\n}\n\nwindow.PowerMenu {\n  background: @theme_bg_color;\n  color: @theme_fg_color;\n  font-weight: bold;\n  border-radius: 10px;\n  padding: 10em;\n}\nwindow.PowerMenu > centerbox {\n  background: @theme_bg_color;\n  border-radius: 10px;\n  padding: 8000em;\n}\nwindow.PowerMenu button {\n  border-radius: 8px;\n  padding: 1em;\n  margin: 0.8em;\n}\nwindow.PowerMenu label.message {\n  font-weight: bolder;\n  padding: 1em;\n}";
...
// widget/powermenu.tsx
function powermenu() {
  return /* @__PURE__ */ jsx("window", { name: "powermenu", setup: (self) => app_default.add_window(self), className: "PowerMenu", keymode: Astal8.Keymode.ON_DEMAND, onKeyPressEvent: function(self, event) {
    if (event.get_keyval()[1] === Gdk.KEY_Escape)
      self.hide();
  }, children: /* @__PURE__ */ jsxs("box", { vertical: true, children: [
    /* @__PURE__ */ jsx("label", { className: "message", label: "Choose wisely, Silver-sama." }),
    MyButton(" \u23FB Shut Down", "systemctl poweroff"),
    MyButton(" \u{F0343} Logout Hyprland", "hyprctl dispatch exit"),
    MyButton(" \uF023 Lockscreen", "echo lockscreen not made yet")
  ] }) });
}
function MyButton(name, command) {
  return /* @__PURE__ */ jsx("button", { label: name, onClicked: command });
}
